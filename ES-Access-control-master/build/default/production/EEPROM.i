...
void EEPROM_init(tEEPROM_INTERRUPT_STATE state){
    ...
    if(state == EEPROM_INT_ENABLE){
        ((*((volatile tRegister8 *)(0x8D))).Bits.BIT4 = 1);
        ((*((volatile tRegister8 *)(0x0B))).Bits.BIT6 = 1);
        ((*((volatile tRegister8 *)(0x0B))).Bits.BIT7 = 1);
    }else {
        ((*((volatile tRegister8 *)(0x8D))).Bits.BIT4 = 0);
    }
...
void EEPROM_writeByte(tByte address, tByte data){
    ...
    if(address >= (0x00) && address <= (0xFF)){
       ...
       while(((*((volatile tRegister8 *)(0x18C))).Bits.BIT1 || (*((volatile tRegister8 *)(0x18C))).Bits.BIT0));


        ((*((volatile tRegister8 *)(0x10D))).Reg = address);


        ((*((volatile tRegister8 *)(0x10C))).Reg = data);



        tByte state = ((*((volatile tRegister8 *)(0x0B))).Bits.BIT7);


        ((*((volatile tRegister8 *)(0x0B))).Bits.BIT7 = 0);


        (*((volatile tRegister8 *)(0x18C))).Bits.BIT7 = 0; (*((volatile tRegister8 *)(0x18C))).Bits.BIT2 = 1; EECON2 = 0x55; EECON2 = 0xAA; (*((volatile tRegister8 *)(0x18C))).Bits.BIT1 = 1; (*((volatile tRegister8 *)(0x18C))).Bits.BIT2 = 0;
...
void EEPROM_readByte(tByte address, tByte *pData){
    ...
    if(address >= (0x00) && address <= (0xFF)){
        ...
        (*((volatile tRegister8 *)(0x18C))).Bits.BIT7 = 0; (*((volatile tRegister8 *)(0x18C))).Bits.BIT0 = 1;;


        *pData = ((*((volatile tRegister8 *)(0x10C))).Reg);
    }
...
void EEPROM_write4Bytes(tByte startAddress, tDword data){
    ...
    if(startAddress >= (0x00) && (startAddress + 3) <= (0xFF)){
         tByte oneByte;
