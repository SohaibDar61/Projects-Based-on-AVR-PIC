...
void KPAD_init(void){
    ...
    ((((*((volatile tRegister8 *)(0x86))).Reg)) = (((1))) ? ((((*((volatile tRegister8 *)(0x86))).Reg)) | 0x0F) : ((((*((volatile tRegister8 *)(0x86))).Reg)) & 0xF0));


    ((((*((volatile tRegister8 *)(0x86))).Reg)) = (((0))) ? ((((*((volatile tRegister8 *)(0x86))).Reg)) | 0xF0) : ((((*((volatile tRegister8 *)(0x86))).Reg)) & 0x0F));



    ((((*((volatile tRegister8 *)(0x06))).Reg)) = ((((*((volatile tRegister8 *)(0x06))).Reg)) & 0x0F) | ((0x0F) << 4) );


    ((*((volatile tRegister8 *)(0x81))).Bits.BIT7 = 0);
...
void KPAD_getKey(tByte * pKey){
    ...
    if((((((*((volatile tRegister8 *)(0x06))).Reg)) & 0x0F)) != (0x0F)){return;}

    for(col = 0; col < (4); col++){

        (((((*((volatile tRegister8 *)(0x06))).Reg)) = ((((*((volatile tRegister8 *)(0x06))).Reg)) & 0x0F) | ((0x0F) << 4) ));
        ((((((*((volatile tRegister8 *)(0x06))).Reg))) = (((((*((volatile tRegister8 *)(0x06))).Reg)) & (~(1 << col + (4)))) | ((0) << col + (4)))));

        row = (((((*((volatile tRegister8 *)(0x06))).Reg)) & 0x0F));
        if (row != (0x0F)){
