...
void switch_update(void){
    ...
    sw_update_counter = sw_update_counter + (5);
...
static void switches_Schematic_init(void){
    ...
    switches_data[sw_setting].ctrl_reg = &(((*((volatile tRegister *)(0x86))).Reg));
    switches_data[sw_setting].data_reg = &(((*((volatile tRegister *)(0x06))).Reg));
    switches_data[sw_setting].pin_number = ((2));
