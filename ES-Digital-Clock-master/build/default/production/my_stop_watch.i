...
# 11 "my_stop_watch.c" 2

# 1 "./DISPLAY.h" 1
# 11 "./DISPLAY.h"
void display_init(void);
void display_update(void);
# 12 "my_stop_watch.c" 2
...
void __attribute__((picinterrupt(("high_priority")))) APP_UPDATE(void){
