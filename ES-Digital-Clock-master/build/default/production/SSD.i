...
void ssd_update(void){
    ...
    ssd_update_counter += (5);

    if (ssd_update_counter == (5)){
        ...
        for(index = ssd_minute_units; index < (4); index++){
            ssd_off(index);
        }
...
static void ssd_schematic_init(void){
     ...
     ssd_data[0] = (tSSD_INFO){&(((*((volatile tRegister *)(0x88))).Reg)),&(((*((volatile tRegister *)(0x08))).Reg)),&(((*((volatile tRegister *)(0x86))).Reg)),&(((*((volatile tRegister *)(0x06))).Reg)),((4)),SSD_NULL};
     ssd_data[1] = (tSSD_INFO){&(((*((volatile tRegister *)(0x88))).Reg)),&(((*((volatile tRegister *)(0x08))).Reg)),&(((*((volatile tRegister *)(0x86))).Reg)),&(((*((volatile tRegister *)(0x06))).Reg)),((5)),SSD_NULL};
     ssd_data[2] = (tSSD_INFO){&(((*((volatile tRegister *)(0x88))).Reg)),&(((*((volatile tRegister *)(0x08))).Reg)),&(((*((volatile tRegister *)(0x86))).Reg)),&(((*((volatile tRegister *)(0x06))).Reg)),((6)),SSD_NULL};
     ssd_data[3] = (tSSD_INFO){&(((*((volatile tRegister *)(0x88))).Reg)),&(((*((volatile tRegister *)(0x08))).Reg)),&(((*((volatile tRegister *)(0x86))).Reg)),&(((*((volatile tRegister *)(0x06))).Reg)),((7)),SSD_NULL};


}
 void ssd_display(tSSD ssd, tSSD_SYMBOL symbol){
    ((*(ssd_data[ssd].data_value_reg)) = (ssd_decoder[symbol]));
...
static void dot_display(tDotState state){
    (((*(ssd_data[ssd_hour_units].data_value_reg)) = ((*(ssd_data[ssd_hour_units].data_value_reg) & (~(1 << ((7))))) | (state << ((7))))));
}
