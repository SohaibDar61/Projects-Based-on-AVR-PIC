 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *         File:  MCP2515_t_interface.h	
 *         Created: 10/7/2022
 *         Author: Sohaib Dar
 *
 *  Description: aLL FUNCTIONS PROTOTYPES of MCP2515     
 *  
 *********************************************************************************************************************/
...
#ifndef MCP2515_T_INTERFACE_H_
#define MCP2515_T_INTERFACE_H_
